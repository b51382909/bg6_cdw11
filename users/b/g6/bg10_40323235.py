...
bg6_40323235 = Blueprint('bg6_40323235', __name__, url_prefix='/bg6_40323235', template_folder='templates')
...
@bg6_40323235.route('/circle')
def drawcircle():
    return head_str + chain_str + circle(0, 0) + tail_str
 
 
@bg6_40323235.route('/circle1/<degree>', defaults={'x': 0, 'y': 0})
@bg6_40323235.route('/circle1/<x>/<degree>', defaults={'y': 0})
@bg6_40323235.route('/circle1/<x>/<y>/<degree>')
...
@bg6_40323235.route('/circle2/<degree>', defaults={'x': 0, 'y': 0})
@bg6_40323235.route('/circle2/<x>/<degree>', defaults={'y': 0})
@bg6_40323235.route('/circle2/<x>/<y>/<degree>')
...
@bg6_40323235.route('/twocircle/<x>/<y>')
@bg6_40323235.route('/twocircle', defaults={'x':0, 'y':0})
def drawtwocircle(x,y):
    return head_str + chain_str + twocircle(int(x), int(y)) + tail_str
 
 
@bg6_40323235.route('/eighteenthirty/<x>/<y>')
@bg6_40323235.route('/eighteenthirty', defaults={'x':0, 'y':0})
def draweithteenthirdy(x,y):
    return head_str + chain_str + eighteenthirty(int(x), int(y)) + tail_str
 
 
@bg6_40323235.route('/snap')
...
'''
    return outstring
@bg6_40323235.route('/threegears', defaults={'n1':15,'n2':20,'n3':18})
@bg6_40323235.route('/threegears/<n1>/<n2>/<n3>')
